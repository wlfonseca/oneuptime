  ...
  return (
    <div className="relative ml-1 flex-shrink-0">
      <div>
        <button
          type="button"
          className="flex items-center justify-center h-9 w-9 rounded-lg bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-600 hover:bg-gray-100 dark:hover:bg-slate-700 hover:border-gray-300 dark:hover:border-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1 dark:focus:ring-offset-slate-900 transition-all duration-150"
          id="user-menu-button"
          aria-expanded="false"
          aria-haspopup="true"
          onClick={() => {
